     ...
     <div id="wrapper">
         ...
         <div id="page-wrapper">
            <div class="container-fluid">
                 <div class="row">
                     <div class="col-lg-12">
                         <h1 class="page-header">Detail data guru</h1>
                         <div class="container">
                                         ...
                                         <div class="card-body">
                                             <form action="{{ route('guru.store') }}" method="POST">
                                                 ...
                                                 <div class="mb-3">
                                                     ...
                                                     <input type="text" class="form-control" name="telepon" value="{{ $guru -> telepon }}" disabled>
                                                     <label class="form-label">E-mail</label>
                                                     <input type="text" class="form-control" name="email" value="{{ $guru -> email }}" disabled>
                                                     <label class="form-label">ID Mapel</label>
                                                     <input type="text" class="form-control" name="id_mapel" value="{{ $guru -> id_mapel }}" disabled>
